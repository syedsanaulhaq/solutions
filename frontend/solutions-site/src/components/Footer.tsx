      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-slate-400 max-w-sm leading-relaxed">
              Custom LMS, AI chatbots, React &amp; Node.js development, and business automation — built by UK engineers for modern businesses worldwide.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-sm text-slate-500">
            © 2026 HostingOcean Solutions. All rights reserved.
          </p>
