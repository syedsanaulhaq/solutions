    ...
    <>
      ...
      <Section variant="default">
        <div className="max-w-3xl mx-auto">
          ...
          <P>All content on this website — including text, graphics, logos, and code — is the property of HostingOcean Solutions or its licensors, protected by UK and international copyright law. You may not reproduce or distribute any content without written permission.</P>
...
export default function TermsPage() {
  return (
    <>
      ...
      <Section variant="default">
        <div className="max-w-3xl mx-auto prose dark:prose-invert prose-slate prose-headings:font-bold prose-headings:tracking-tight prose-p:leading-relaxed prose-p:text-muted-foreground prose-li:text-muted-foreground">

          <p className="text-sm text-muted-foreground mb-8">Last updated: April 2026</p>

          <h2>1. Acceptance of Terms</h2>
          <p>
            By accessing or using the HostingOcean Solutions website (solutions.hostingocean.co.uk) or engaging our services, you agree to be bound by these Terms of Service. If you do not agree, please do not use our website or services.
          </p>

          <h2>2. Services</h2>
          <p>
            HostingOcean Solutions provides custom software development services including but not limited to: LMS development, AI chatbot development, React and Next.js development, Node.js API development, and business process automation. Specific terms for each engagement are governed by a separate written agreement between HostingOcean Solutions and the client.
          </p>

          <h2>3. Website Use</h2>
          <p>
            You may use our website for lawful purposes only. You must not use the website to transmit harmful, unlawful, or deceptive content, or attempt to gain unauthorised access to any part of our systems.
          </p>

          <h2>4. Intellectual Property</h2>
          <p>
            All content on this website — including text, graphics, logos, and code — is the property of HostingOcean Solutions or its licensors, protected by UK and international copyright law. You may not reproduce or distribute any content without written permission.
          </p>
          <p>
            For client projects, intellectual property ownership is governed by the specific project agreement. Standard terms transfer full IP ownership to the client upon final payment.
          </p>

          <h2>5. Disclaimers</h2>
          <p>
            This website and its content are provided &ldquo;as is&rdquo; without warranties of any kind. We do not guarantee that the website will be error-free or uninterrupted. Any information on this website is provided for general informational purposes only and does not constitute professional advice.
          </p>

          <h2>6. Limitation of Liability</h2>
          <p>
            To the fullest extent permitted by UK law, HostingOcean Solutions shall not be liable for any indirect, incidental, or consequential damages arising from your use of this website. Our total liability in connection with the website shall not exceed £100.
          </p>
          <p>
            Liability for project engagements is governed by the separate project agreement.
          </p>

          <h2>7. Links to Third-Party Sites</h2>
          <p>
            Our website may contain links to third-party websites. We are not responsible for the content or privacy practices of those sites. Links do not constitute endorsement.
          </p>
          ...
          <h2>9. Changes to These Terms</h2>
          <p>
            We may update these Terms of Service from time to time. Changes will be posted on this page with an updated date. Continued use of our website after changes constitutes acceptance.
          </p>

          <h2>10. Contact</h2>
          <p>
            For any questions about these terms, contact us at{' '}
            <a href="mailto:info@solutions.hostingocean.co.uk">info@solutions.hostingocean.co.uk</a>.
          </p>
        </div>
      </Section>
